...
#define DEF_DIAL_SPAN					270L 
#define DEF_METER_USTEPS				(u32)(DEF_DIAL_SPAN * STEPS_PER_DEGREE)  
#define DEF_MICROSTEPS_EXTRA			(DEF_METER_USTEPS + 38)

#define FULL_HOME_STEPS 				6160	//320 degree

#define EXTRA_STEPS_COMPENSATE 			180u
// Global declarations ------------------------------------------------------
