...
///////////////////////////////////////////////////////////////////////
  ...
  // liveParam_struct.p2_live = 12245;
   ...
   if(liveParam_struct.live_div_f  <  0 )// This is used to check whether live divisor is coming out to be negtive than it will used calibrated stored divisor only
