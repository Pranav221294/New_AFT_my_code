...
#define BOOTLOADER_IDENTIFIER 1
...
//LFC Byte 4 + PreFuelConsume Byte  4 + Trip Offset Byte 2 + Trip Afevalue Byte 2 +  EEPROMOffsetFlag 1 + ReadCount
...
extern u8 u8ReprogrammingCounter[REPROGRAMMING_COUNTER_BYTES];
...
typedef enum
{
	eBootLoaderIdentifier	= 1		,			//Bootloader Identifier
	eOdoIdentifier					,	
	eHourIdentifier					,
	eTripAAfeIdentifier				,
	eTripBAfeIdentifier				,
...
void vSaveBootloaderState(u8 );

u32 u32GetDuplicateOdo();
void vSaveDuplicateOdo(u32 );

u32 u32GetDuplicateHour();
void vSaveDuplicateHour(u32 );
