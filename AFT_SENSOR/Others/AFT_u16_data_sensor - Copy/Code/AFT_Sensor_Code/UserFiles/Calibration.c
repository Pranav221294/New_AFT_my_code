...
void calculateParamAndSaveInFlash(void)
{
	// #ifdef TEST_CALIBRATION_DATA
	  ...
	  caliPara_struct.p0_empty	= 9576;//
	 caliPara_struct.p1_empty	= 14727;  //13909;
	 caliPara_struct.p2_empty	= 15764;//14443;
	 caliPara_struct.p1_full		= 17355;
	 caliPara_struct.p2_full		= 18199;
