...
void vSetInternalDtcSaveFlag(bool );
u8 u8GetNoFaultDtcCount(SUPPORTED_DTC);
u8 u8GetDtcStatus(SUPPORTED_DTC );
bool bGetDtcChangedFlag(SUPPORTED_DTC );
bool bGetDtcEnableFlag(SUPPORTED_DTC );
bool bGetDtcLoggedFlag(SUPPORTED_DTC );
bool bGetDtcOneTimeCheckFlag(SUPPORTED_DTC );
void SetNoFaultDtcCount(SUPPORTED_DTC  , u8 );
void SetDtcStatus(SUPPORTED_DTC  , u8 );
void SetDtcChangedFlag(SUPPORTED_DTC  , bool );
void SetDtcEnableFlag(SUPPORTED_DTC  , bool );
void SetDtcLoggedFlag(SUPPORTED_DTC  , bool );
void SetDtcOneTimeCheckFlag(SUPPORTED_DTC  , bool );
