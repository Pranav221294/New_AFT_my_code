...
#define CONST_1_40_256                      ((uint16_t)358)
#define CONST_1_05_256                      ((uint16_t)269)
...
s16 calculateFuelLevel(void)
{
    ...
    if (firstTimeEntry == 0 )
    {
        ...
        storedParam_struct.span_stored_u16  =   vRead_Span_cal_u16_fromFlash();
        storedParam_struct.cali_status      =   vRead_Cali_Status_fromFlash();
    }

    //storedParam_struct.div_Avg_Stored   =   vRead_Div_Avg_Store_fromFlash();
    storedParam_struct.div_Avg_Stored_u16 =   vRead_Div_Avg_u16_Store_fromFlash(); 
...
///////////////////////////////////////////////////////////////////////
    ...
    liveParam_struct.p0_live = 9755;
    liveParam_struct.p1_live = 24244;
    liveParam_struct.p2_live = 19728;
    // if(lastP1 == -1)
    // {
    ...
    liveParam_struct.p1_drift_factor = (1.4f * (int)(liveParam_struct.p0_live - storedParam_struct.p0_stored)) ;
    ...
    liveParam_struct.p2_drift_factor = 1.05f * (int)(liveParam_struct.p0_live - storedParam_struct.p0_stored) ;

    /* Current level in Probe 1 */
    liveParam_struct.current_level_p1 = liveParam_struct.p1_live - liveParam_struct.p1_drift_factor - storedParam_struct.p1E_stored;

    /* Current level in Probe 2 */
    liveParam_struct.current_level_p2 = liveParam_struct.p2_live - liveParam_struct.p2_drift_factor - storedParam_struct.p2E_stored ;
   ...
   // if ( (liveParam_struct.current_level_p1)  < ( 0.2f * caliPara_struct.raw_p1_span))
    if  ((liveParam_struct.current_level_p1)  < (s16)( (20ul * (uint32_t)caliPara_struct.raw_p1_span)/100ul))
    {
    ...
    liveParam_struct.live_div = (storedParam_struct.m_stored_u16 * (1.0 * liveParam_struct.current_level_p1 / liveParam_struct.current_level_p2)) - CONST_6_3_4096 ;
    //liveParam_struct.live_div = getFloatUpto3place(liveParam_struct.live_div_f);
