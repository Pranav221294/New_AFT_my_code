...
; W, STATUS, BSR, FSR, and PCLATH
	...
	BANKSEL	0
BTFSC   PORTC, 0    ; Check the status of RC0 (bit 0 of PORTC)
	GOTO    RC0_IS_HIGH ; If RC0 is high, jump to RC0_IS_HIGH
	BSF     PORTC, 0    ; If RC0 is low, set it high
	GOTO    CONTINUE

RC0_IS_HIGH:
	BCF     PORTC, 0    ; If RC0 is high, clear it to make it low
