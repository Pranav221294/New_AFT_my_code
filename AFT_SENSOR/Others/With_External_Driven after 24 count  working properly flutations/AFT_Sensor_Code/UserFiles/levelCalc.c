...
ThreeBytes p0,p1,p2;
ThreeBytes shift_p0,shift_p1,shift_p2; 
/****************************************************************************************************************/
...
s16 calculateFuelLevel(void)
{
  ...
  //  u16 dataTempPx = 0 ;        // testing
    ...
    ThreeBytes ThreeBytes_temp_live;
//     u16 m = 2433;
//     u16 p1 = 10304;
//     u16 p2 = 5293;
//     u16 lz;
...
//    dataTempPx = ((uint16_t)(shifting_of_merge_overflow_n_reg_v( p0_raw.TD10_overflow_v,p0_raw.TD10_value_reg_v,4))); 
  // p0_dataTempPx = ((uint16_t)(shifting_of_merge_overflow_n_reg_v( p0_raw.TD10_overflow_v,p0_raw.TD10_value_reg_v,0)));;
   p0 = merge_and_get_bytes(p0_raw.TD10_overflow_v, p0_raw.TD10_value_reg_v);
   ThreeBytes_temp_live = merge_and_get_bytes(p0_raw.TD10_overflow_v, p0_raw.TD10_value_reg_v);
   ThreeBytes_temp_live = leftShiftBytesN(ThreeBytes_temp_live,4); 
   shift_p0 = ThreeBytes_temp_live;
   dataTempPx= merge_first_two_bytes(ThreeBytes_temp_live);
   getMovingAveargeOf(e_LiveP0, &dataTempPx, &resultAvg);

    // liveParam_struct.p0_live = dataTempPx  ; 
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    p1 = merge_and_get_bytes(p1_raw.TD10_overflow_v, p1_raw.TD10_value_reg_v);
    ThreeBytes_temp_live = merge_and_get_bytes(p1_raw.TD10_overflow_v, p1_raw.TD10_value_reg_v);
    ThreeBytes_temp_live = leftShiftBytesN(ThreeBytes_temp_live,4); 
    shift_p1 = ThreeBytes_temp_live;
    dataTempPx= merge_first_two_bytes(ThreeBytes_temp_live); 
    ...
    //liveParam_struct.p1_live = getAccumalatedCount(samples_struct.accCount_p1, VALUE_FOR_SUBSTRACTION - tempP1, ACCUMULATE);
     //liveParam_struct.p1_live = getAccumalatedCount(samples_struct.accCount_p1, resultAvg, ACCUMULATE);
      ...
      //liveParam_struct.p1_live = dataTempPx;
  ...
  /*********************************************************************************** get p2 live counts *************************************************************/
    ...
    //   dataTempPx = ((uint16_t)(shifting_of_merge_overflow_n_reg_v( p2_raw.TD10_overflow_v,p2_raw.TD10_value_reg_v,4))); 
     //  p2_dataTempPx = ((uint16_t)(shifting_of_merge_overflow_n_reg_v( p2_raw.TD10_overflow_v,p2_raw.TD10_value_reg_v,0)));
      p2 =   merge_and_get_bytes(p2_raw.TD10_overflow_v, p2_raw.TD10_value_reg_v);
      ThreeBytes_temp_live = merge_and_get_bytes(p2_raw.TD10_overflow_v, p2_raw.TD10_value_reg_v);
      ThreeBytes_temp_live = leftShiftBytesN(ThreeBytes_temp_live,4); 
      shift_p2 = ThreeBytes_temp_live;
...
//     //liveParam_struct.p2_live = getAccumalatedCount(samples_struct.accCount_p2, VALUE_FOR_SUBSTRACTION - tempP2, ACCUMULATE);
  ...
  //    liveParam_struct.p2_live = 15017;
       //liveParam_struct.p2_live = dataTempPx;
