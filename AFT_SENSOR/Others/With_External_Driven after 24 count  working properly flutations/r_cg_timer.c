...
void R_TAU1_Create(void)
{
    ...
    // TMPR110 = 1U;
    // TMPR010 = 1U;
     /* Set INTTM10 high priority */
    TMPR110 = 0U;
    TMPR010 = 0U;
    /* Channel 0 used as interval timer */
    TMR10 = _0000_TAU_CLOCK_SELECT_CKM0 | _0000_TAU_CLOCK_MODE_CKS | _0000_TAU_MODE_INTERVAL_TIMER |
            _0001_TAU_START_INT_USED;
    //TDR10 = _0007_TAU_TDR10_VALUE;
    TDR10 = _CB1F_TAU_TDR10_VALUE;
      //TDR10 = 65535;
