...
#define _70_PM2_DEFAULT          (0x70U) /* PM2 default value */
#define _F4_PM3_DEFAULT          (0xF4U) /* PM3 default value */
#define _FE_PM4_DEFAULT          (0xFEU) /* PM4 default value */
#define _0F_PM5_DEFAULT          (0x0FU) /* PM5 default value */
#define _FC_PM6_DEFAULT          (0xFCU) /* PM6 default value */
#define _C3_PM7_DEFAULT          (0xC3U) /* PM7 default value */
#define _F0_PM8_DEFAULT          (0xF0U) /* PM8 default value */
#define _E0_PM9_DEFAULT          (0xE0U) /* PM9 default value */
