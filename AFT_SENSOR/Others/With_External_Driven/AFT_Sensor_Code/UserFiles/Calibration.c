...
u32 Calib_p0_merge=0,Calib_p1_merge=0,Calib_p2_merge=0;
...
void vEmptyCalibration(void)
{
	...
	Calib_p1_merge = merge_of_overflow_n_reg_value(p1_raw.TD10_overflow_v,p1_raw.TD10_value_reg_v);
    Calib_p1_merge = Calib_p1_merge >> 8;
    tempPxAcc = (u16)Calib_p1_merge;
	caliPara_struct.p1_empty = getAccumalatedCount(accu_v.Accum_p1, tempPxAcc, ACCUMULATED_COUNT_CALI);


    Calib_p2_merge = merge_of_overflow_n_reg_value(p2_raw.TD10_overflow_v,p2_raw.TD10_value_reg_v);
    Calib_p2_merge = Calib_p2_merge >> 8;
	tempPxAcc = (u16)Calib_p2_merge ;
...
void vFullCalibration(void)
{
   ...
   Calib_p1_merge = merge_of_overflow_n_reg_value(p1_raw.TD10_overflow_v,p1_raw.TD10_value_reg_v);
    Calib_p1_merge = Calib_p1_merge >> 8;
    tempPxAcc = (u16)Calib_p1_merge;
	caliPara_struct.p1_full = getAccumalatedCount(accu_v.Accum_p1, tempPxAcc, ACCUMULATED_COUNT_CALI);


    Calib_p2_merge = merge_of_overflow_n_reg_value(p2_raw.TD10_overflow_v,p2_raw.TD10_value_reg_v);
    Calib_p2_merge = Calib_p2_merge >> 8;
	tempPxAcc = (u16)Calib_p2_merge ;
	caliPara_struct.p2_full = getAccumalatedCount(accu_v.Accum_p2, tempPxAcc, ACCUMULATED_COUNT_CALI);
