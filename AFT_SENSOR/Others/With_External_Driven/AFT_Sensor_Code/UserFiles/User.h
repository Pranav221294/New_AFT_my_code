...
*/
#define MAX_VAL_TDR25_FOR_100_DUTY								1151ul//819ul//711UL		// for 19.531kHz PWM Freq
#define MAX_VAL_TDR25_FOR_50_DUTY								565ul//(MAX_VAL_TDR25_FOR_100_DUTY / 2u )


//#define MAX_OUT_VOL_AT_100_DUTY									9000UL		// at connector out PIN, 10000 means 10V
#define MAX_OUT_VOL_AT_50_DUTY									5000UL		// at connector out PIN, 10000 means 10V
...
//#define MAX_VALUE_AT_FULL_LEVEL									460		// value of Q1
...
#define ACCUMULATE                                  16              // don't change it unless required 
...
typedef struct 
{
    ...
    u8     Avg_TD10_overflow_v;
    u16    Avg_TD10_value_reg_v;
