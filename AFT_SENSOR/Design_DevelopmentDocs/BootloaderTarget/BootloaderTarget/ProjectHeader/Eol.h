...
*******************************************************************************************************/
#define	VEHICLE_TYPE_BYTES					5
#define	SPEED_SENSOR_BYTES					5
#define	FE_INDICATOR_THRESH_BYTES			4
#define	AIR_PRESSURE_OPTION_BYTES			8
#define	COOLANT_TEMP_OPTION_BYTES			3
#define	AFE_OPTIONS_BYTES					2
#define	LOW_OIL_PRESSURE_THRESH_BYTES		2
#define	DISPLAY_SCREEN_CONFIG_BYTES			2
#define	TELLTALES_OPTION_BYTES				4
#define	BUZZER_OPTION_BYTES					3
#define ENGINE_OVER_SPEED_BYTES				2
#define DTE_MUL_FACTOR_BYTE					2
#define ODO_WRITE_BYTES						3
#define SERVICE_BYTES						3
#define FUEL_TANK_CAP_LEN					2
#define CAN_SPEEDO_FACTOR_LEN				6



#define	DATE_OF_LAST_PROGRAMMING_BYTES		4
#define	VEHICLE_ID_BYTES					17
#define	VARIANT_DA_SET_ID_BYTES				5	//5th byte for eol pending
#define	VEHICLE_CONFIG_NUMBER_BYTES			15
#define	PARAMETER_PART_NUMBER_BYTES			17
#define	PROGRAMMING_SHOP_CODE_BYTES			5


#define	ECU_SERIAL_NUMBER_BYTES				12
#define	ECU_PART_NUMBER_BYTES				12
#define	TML_ECU_HARDWARE_NUMBER_BYTES		15
#define	TML_CONTAINER_PART_NUMBER_BYTES		12
#define	TML_SOFTWARE_CALIBERATION_ID_BYTES	2
#define	TML_ECU_SOFTWARE_NUMBER_BYTES		15
#define	REPROGRAMMING_COUNTER_BYTES			2
#define	ECU_HARDWARE_VERSION_BYTES			2
#define IIL_SVN_NUMBER_BYTES				4
#define IIL_PCB_NUMBER_BYTES				8
