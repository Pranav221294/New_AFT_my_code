...
/* MODULE TML_14229_UDSH */
  //Negative Responses
  //these all written priority wise 
...
#define TransferExitResponceService				0x77
...
#define NUM_READ_ID_SUPPORTED 3 // "dataTxBuffer[MAX_LENGTH + 20]" max byte response 69 and max length of parameter 15 * 4 = 60 + dignostic byte 
...
typedef struct
{
	...
	union
	{
		...
		struct
		{
			...
			u8 DefEnableFlag : 1; //bit 0
			u8 OilPressureEnableFlag : 1;
			u8 RearApgEnableFlag : 1;
			u8 FrontApgEnableFlag : 1; 			
			u8 FuelGaugeFlag : 1;
			u8 TempGaugeFlag : 1; //bit 7
			u8 tachometerFlag : 1;
			u8 speedometerFlag : 1;					
...
#define TransferExitService		 					0x37
...
extern void RequestDownload(void);
extern void TransferData(void);
extern void TransferExit(void);
